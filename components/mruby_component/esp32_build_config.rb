...
MRuby::CrossBuild.new('esp32') do |conf|
  ...
  conf.gem :github => "mruby-esp32/mruby-io",           :branch => '0.4'
  conf.gem :github => "mruby-esp32/mruby-socket",       :branch => '0.4'
  conf.gem :github => "mruby-esp32/mruby-esp32-system", :branch => '0.4'
  conf.gem :github => "mruby-esp32/mruby-esp32-gpio",   :branch => '0.4'
  conf.gem :github => "mruby-esp32/mruby-esp32-wifi",   :branch => '0.4'
end
